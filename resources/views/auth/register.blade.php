...
<head>
    ...
    <meta name="description" content="ORDA - Créez votre compte administrateur">
    
    <title>Inscription – ORDA</title>
    ...
    <div class="w-full max-w-md px-6 py-12 relative z-10">
        ...
        <div class="bg-orda-white rounded-2xl shadow-[0_40px_80px_rgba(0,0,0,0.08)] border border-orda-gray-100 p-10 fade-in-up delay-100">
            ...
            <div class="text-center mb-8">
                <h1 class="text-2xl font-bold text-orda-black mb-2">Créer un compte</h1>
                <p class="text-orda-gray-500">Rejoignez ORDA et gérez vos boutiques</p>
            </div>
            ...
            <form method="POST" action="{{ route('register') }}" id="registerForm" novalidate>
                ...
                <!-- Name -->
                <div class="mb-5">
                    <label for="name" class="block text-sm font-semibold text-orda-black mb-3">Nom complet</label>
                    <input 
                        type="text" 
                        id="name" 
                        name="name" 
                        ...
                        class="w-full px-5 py-4 bg-orda-white-off border-2 border-orda-gray-200 rounded-xl text-orda-black placeholder-orda-gray-400 transition-all duration-300 input-focus-gold @error('name') border-red-500 @enderror"
                    >
                    @error('name')
                        <p class="mt-2 text-sm text-red-500">{{ $message }}</p>
                    @else
                        <p class="mt-2 text-sm text-orda-gray-400 hidden" id="nameError">Le nom est requis</p>
                    @enderror
                </div>
                ...
                <div class="mb-5">
                    ...
                    @error('password')
                        <p class="mt-2 text-sm text-red-500">{{ $message }}</p>
                    @else
                        <p class="mt-2 text-sm text-orda-gray-400 hidden" id="passwordError">Le mot de passe doit contenir au moins 8 caractères</p>
                    @enderror
                </div>

                <!-- Confirm Password -->
                <div class="mb-6">
                    <label for="password_confirmation" class="block text-sm font-semibold text-orda-black mb-3">Confirmer le mot de passe</label>
                    <div class="relative">
                        <input 
                            type="password" 
                            ...
                            autocomplete="new-password"
                            placeholder="••••••••"
                            class="w-full px-5 py-4 bg-orda-white-off border-2 border-orda-gray-200 rounded-xl text-orda-black placeholder-orda-gray-400 transition-all duration-300 input-focus-gold"
                        >
                        <button 
                            type="button" 
                    ...
                    <p class="mt-2 text-sm text-orda-gray-400 hidden" id="passwordConfirmError">Les mots de passe ne correspondent pas</p>
                </div>
            ...
            <div class="mt-8 text-center">
                <p class="text-orda-gray-500">
                    Déjà inscrit ?
                    <a href="{{ route('login') }}" class="font-semibold link-gold ml-1">
                        Se connecter
                    </a>
                </p>
            </div>
