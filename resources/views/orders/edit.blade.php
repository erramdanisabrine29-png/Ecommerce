                ...
                <form action="{{ route('orders.update', $order) }}" method="POST" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" 
                                   ...
                                   style="border-color:#E5E5E5; color:#666666; background-color:#F8F8F8;">
                        </div>
                        ...
                        <div>
                            ...
                            <select name="channel" 
                                ...
                                <option value="website" {{ old('channel', $order->channel) == 'website' ? 'selected' : '' }}>Website</option>
                                <option value="phone" {{ old('channel', $order->channel) == 'phone' ? 'selected' : '' }}>Phone</option>
                                <option value="email" {{ old('channel', $order->channel) == 'email' ? 'selected' : '' }}>Email</option>
                                <option value="pos" {{ old('channel', $order->channel) == 'pos' ? 'selected' : '' }}>POS</option>
                                <option value="marketplace" {{ old('channel', $order->channel) == 'marketplace' ? 'selected' : '' }}>Marketplace</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <select name="id_customer" 
                                ...
                                @isset($customers)
                                    @foreach($customers as $customer)
                                        <option value="{{ $customer->id_customer }}" {{ old('id_customer', $order->id_customer) == $customer->id_customer ? 'selected' : '' }}>
                        ...
                        <div>
                            ...
                            <select name="id_site" 
                                    ...
                                    onfocus="this.style.borderColor='#D4AF37'; this.style.boxShadow='0 0 0 3px rgba(212,175,55,0.1)';"
                                    onblur="this.style.borderColor='#E5E5E5'; this.style.boxShadow='none';">
                                <option value="" disabled>{{ __('Select a site') }}</option>
                                @isset($sites)
                                    @foreach($sites as $site)
                                        <option value="{{ $site->id_site }}" {{ old('id_site', $order->id_site) == $site->id_site ? 'selected' : '' }}>
                                            {{ $site->site_name }}
                                        </option>
                                    @endforeach
                                @endisset
                    ...
                    <div>
                        ...
                        <textarea name="customer_notes" 
                                  ...
                                  onfocus="this.style.borderColor='#D4AF37'; this.style.boxShadow='0 0 0 3px rgba(212,175,55,0.1)';"
                                  onblur="this.style.borderColor='#E5E5E5'; this.style.boxShadow='none';"
                                  placeholder="{{ __('Optional notes from the customer') }}">{{ old('customer_notes', $order->customer_notes) }}</textarea>
                    </div>
